...
import { ForgotPasswordComponent } from './templates/landing-template/forgot-password/forgot-password.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    component: BaseTemplateComponent,
    data: { roles: [Role.Admin] },
    loadChildren: () => import('./pages/vehicles-list/vehicles-list.module').then((m) => m.VehiclesListModule),
  },
  {
    path: 'suppliers-list',
    canActivate: [AuthGuard],
