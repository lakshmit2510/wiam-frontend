...
@Component({
  ...
  styleUrls: ['./add-new-vehicle.component.less']
})
export class AddNewVehicleComponent implements OnInit {
  ...
  constructor(private vehicleListService: VehicleListService, private msg: NzMessageService) { }
